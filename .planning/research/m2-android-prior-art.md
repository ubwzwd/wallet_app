---
title: M2 Android Development Guide (prior art)
source_branch: feat/m2-android-mobile-support
source_commit: 1f45cc3 (feat: Add Android mobile support and React Native compatibility fixes)
captured: 2026-05-24
captured_by: archival before deleting source branch
status: reference-only — code companion (frontend changes in source commit) was not merged due to ~6mo divergence from main; docs preserved here for Phase 6 / M2-Android planning
---

> **Provenance:** This document was extracted from the `feat/m2-android-mobile-support` branch (last touched 2025-11, 6 months before extraction) before that branch was deleted. The 3 commits on that branch modified frontend files that have since been rewritten by Phase 1–4 work; merging the code is not viable. This guide is preserved as planning input for M2 Android work in a future phase.
>
> Original file path on source branch: `ANDROID_DEV_GUIDE.md` (repo root)
